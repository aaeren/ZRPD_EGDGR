*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_ZRPD_EGDGR_V_SRU
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_ZRPD_EGDGR_V_SRU    .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_ZRPD_EGDGR_V_SRU'
         EXPORTING
              FCODE          = READ
...
EXTRACT = ZRPD_EGDGR_V_SRU_EXTRACT
TOTAL = ZRPD_EGDGR_V_SRU_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_ZRPD_EGDGR_V_SRU'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_ZRPD_EGDGR_V_SRU-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZRPD_EGDGR_V_SRU_EXTRACT
TOTAL = ZRPD_EGDGR_V_SRU_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_ZRPD_EGDGR_V_SRU-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_ZRPD_EGDGR_V_SRU'
...
TOTAL = ZRPD_EGDGR_V_SRU_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_ZRPD_EGDGR_V_SRU-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_ZRPD_EGDGR_V_SRU-UPD_FLAG NE SPACE.
...
CALL FUNCTION 'VIEWPROC_ZRPD_EGDGR_V_SRU'
                    ...
                    IMPORTING
                              UPDATE_REQUIRED =
STATUS_ZRPD_EGDGR_V_SRU-UPD_FLAG
                    TABLES
                        EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZRPD_EGDGR_V_SRU_EXTRACT
TOTAL = ZRPD_EGDGR_V_SRU_TOTAL
