*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_ZRPD_EGDGR_V_KAT
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_ZRPD_EGDGR_V_KAT    .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_ZRPD_EGDGR_V_KAT'
         EXPORTING
              FCODE          = READ
...
EXTRACT = ZRPD_EGDGR_V_KAT_EXTRACT
TOTAL = ZRPD_EGDGR_V_KAT_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_ZRPD_EGDGR_V_KAT'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_ZRPD_EGDGR_V_KAT-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZRPD_EGDGR_V_KAT_EXTRACT
TOTAL = ZRPD_EGDGR_V_KAT_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_ZRPD_EGDGR_V_KAT-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_ZRPD_EGDGR_V_KAT'
...
TOTAL = ZRPD_EGDGR_V_KAT_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_ZRPD_EGDGR_V_KAT-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_ZRPD_EGDGR_V_KAT-UPD_FLAG NE SPACE.
...
CALL FUNCTION 'VIEWPROC_ZRPD_EGDGR_V_KAT'
                    ...
                    IMPORTING
                              UPDATE_REQUIRED =
STATUS_ZRPD_EGDGR_V_KAT-UPD_FLAG
                    TABLES
                        EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZRPD_EGDGR_V_KAT_EXTRACT
TOTAL = ZRPD_EGDGR_V_KAT_TOTAL
